<%@ Page Title="" Language="C#" MasterPageFile="~/Web.Master" AutoEventWireup="true" CodeBehind="StudentEdit.aspx.cs" Inherits="LibraryManagementASP.net.Student.StudentEdit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    
     <fieldset>
        <legend>Student Info Update :</legend>
