<%@ Page Title="" Language="C#" MasterPageFile="~/Web.Master" AutoEventWireup="true" CodeBehind="BookEntry.aspx.cs" Inherits="LibraryManagementASP.net.Book.BookEntry" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <link href="../Content/bootstrap-datepicker.min.css" rel="stylesheet" />
    <script src="../Scripts/bootstrap-datepicker.js"></script>
    <fieldset>
        <legend>Book Info Entry :</legend>
    </fieldset>
